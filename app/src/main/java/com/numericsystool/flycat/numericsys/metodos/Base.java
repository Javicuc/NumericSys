...
public class Base {
    ...
    public String reportarmatriz(double[][] matriz) {
        ...
        Resultado += this.reportarmatriz(matriz, ancho);
        return Resultado;
    }
    ...
    public String reportarmatriz(double[][] matriz, int ancho) {
        ...
        Resultado += (this.redondear("", 3 + 1));

        for (int i = 0; i < matriz[0].length; i++) {
            if ((matriz[0].length - 1) == i) {
                Resultado += (this.redondear(i + "", ancho + 1, true));
            } else {
                Resultado += (this.redondear(i + "", ancho, true));
            }
        }
        ...
        for (int i = 0; i < matriz.length; i++) {
            Resultado += (this.redondear(i + "", 3, true));
            Resultado += this.reportarFilamatriz(matriz[i], ancho);
        }
        Resultado += System.getProperty("line.separator");
        return Resultado;
    }
    ...
    public String reportarFilamatriz(double[] fila, int ancho) {
        ...
        for (int i = 0; i < fila.length; i++) {
            ...
            if ((fila.length - 1) == i) {
                Resultado += ("|" + this.redondear(numero, ancho, true));
            } else {
                Resultado += (this.redondear(numero, ancho, true));
            }
        }
    ...
    public String reportarcoordenadas(double[] x, double[] y) {
        ...
        for (int i = 0; i < coordenadas.length; i++) {
            ...
            if (i == 0) {
                resultado += (this.redondear("X", 5, true));
            } else {
                resultado += (this.redondear("f(x)", 5, true));
            }

            resultado += this.reportarFilacoordenadas(coordenadas[i], ancho);
